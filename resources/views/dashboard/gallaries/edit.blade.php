    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="kt-portlet">
                ...
                <form class="kt-form p-3 " method="POST" action="{{ route('gallaries.update',$gallary) }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                ...
                                <div class="border mt-2">
                                    <img  width="150px" height="100px" src="{{ $gallary->image_path }}" alt="your image" />
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="ar[name]" value="{{ $gallary->translate('ar')->name }}" class="form-control {{ input_has_error('ar.name',$errors) }}" placeholder="الإسم">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="en[name]" value="{{ $gallary->translate('en')->name }}" class="form-control {{ input_has_error('ar.name',$errors) }}" placeholder="الإسم">
                        ...
                        <div class="row col-12">
                            <div class="col-8">
                                ...
                                <div class="form-group ">
                                    <input id="pro_img" name="old_images[{{ $image->id }}][image]" type="file" onchange="readURL(this);" />
                                    <img class="image-preview" width="150px" height="100px" src="{{ $image->image_path }}" alt="your image" />
                                </div>
                            </div>

                            <div class="kt-form__group--inline col-2 mt-2">
                                <a href="{{ route('images.destroy',$image) }}" class="delete_investigation btn-sm btn btn-label-danger btn-bold">
