            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label d-flex justify-content-between w-100">
                        <h3 class="kt-portlet__head-title"> اضافة درس جديد </h3>
                    </div>
                </div>
                <!--END:: TITLE-->

                <!--START:: ADD NEW EMPLOYEE FORM-->
                <form class="kt-form p-3 " method="POST" action="{{ route('courses.lessons.store',[$course]) }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <select class="form-control kt-selectpicker" name="status" data-size="2" data-live-search="true">
                                        <option value="enrollers"> للمشتركين فقط </option>
                                        <option value="visitors"> للزوار </option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12 timepicker">
                                    ...
                                    <input type="text" name="url" class="form-control {{ input_has_error('url',$errors) }}" placeholder="رابط الفديو">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12 timepicker" style="direction: ltr;">
                                    <span class="input-group-text">
                                        <i class="la la-clock-o" style="font-size: 18px"></i>
                                    </span>
                                    <input class="form-control" name="duration" id="kt_timepicker_2" readonly placeholder="Select time" type="text" />
                                    {{-- <input id="hours" class="form-control"  name="value" value="00" size="3"/> --}}
                                </div>
                            </div>
                        </div>
