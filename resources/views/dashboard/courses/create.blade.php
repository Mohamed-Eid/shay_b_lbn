            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label d-flex justify-content-between w-100">
                        <h3 class="kt-portlet__head-title"> اضافة كورس جديد </h3>
                    </div>
                </div>
                <!--END:: TITLE-->

                <!--START:: ADD NEW EMPLOYEE FORM-->
                <form class="kt-form p-3 " method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="promo_video" class="form-control {{ input_has_error('promo_video',$errors) }}" placeholder="رابط البرومو فيديو">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="price" class="form-control {{ input_has_error('price',$errors) }}" placeholder="سعر الكورس">
                            ...
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <select class="form-control kt-selectpicker" name="badges[]" data-size="3" data-live-search="true" multiple>
                                        ...
                                        <option value="{{ $badge }}"> {{ Str::ucfirst(str_replace("_"," ",$badge))  }}  </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
