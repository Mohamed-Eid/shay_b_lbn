            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label d-flex justify-content-between w-100">
                        <h3 class="kt-portlet__head-title"> تعديل المشروع </h3>
                    </div>
                </div>
                <!--END:: TITLE-->

                <!--START:: ADD NEW EMPLOYEE FORM-->
                <form class="kt-form p-3 " method="POST" action="{{ route('projects.update',$project) }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="border mt-2">
                                    <img  width="150px" height="100px" src="{{ $project->image_path }}" alt="your image" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="border mt-2">
                                    <img  width="150px" height="100px" src="{{ $project->header_path }}" alt="your image" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="ar[name]" value="{{ $project->translate('ar')->name }}" class="form-control {{ input_has_error('ar.name',$errors) }}" placeholder="الإسم">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="en[name]" value="{{ $project->translate('en')->name }}" class="form-control {{ input_has_error('ar.name',$errors) }}" placeholder="الإسم">
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                <textarea class="default-ar {{ input_has_error('ar.description',$errors) }}" name="ar[description]">{!! $project->translate('ar')->description !!}</textarea>
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    <textarea class="default-en" name="en[description]">{!! $project->translate('en')->description !!}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="form-group ">
                                    <input id="pro_img" name="old_investigations[{{ $investigation->id }}][image]" type="file" onchange="readURL(this);" />
                            ...
                            <div class="col-6">
                                <div class="input-group-prepend col-12 my-2">
                                    ...
                                    <input type="text" name="old_investigations[{{ $investigation->id }}][ar_name]" value="{{ $investigation->translate('ar')->name }}" class="form-control d-block" placeholder="الاسم باللغة العربية">
                                </div>

                                <div class="input-group-prepend col-12 my-2">
                                    <span class="input-group-text"> <i class="la la-pencil" style="font-size: 18px"></i>
                                    </span>
                                    <input type="text" name="old_investigations[{{ $investigation->id }}][en_name]" value="{{ $investigation->translate('en')->name }}" class="form-control d-block" placeholder="الاسم باللغة الانجليزيه">
                                </div>
                            </div>

                            <div class="kt-form__group--inline col-2 mt-2">
                                <a href="{{ route('investigations.destroy',$investigation) }}" class="delete_investigation btn-sm btn btn-label-danger btn-bold">
