            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label d-flex justify-content-between w-100">
                        <h3 class="kt-portlet__head-title"> تعديل مدرب  </h3>
                    </div>
                </div>
                <!--END:: TITLE-->

                <!--START:: ADD NEW EMPLOYEE FORM-->
                <form class="kt-form p-3" method="POST" action="{{ route('instructors.update',$instructor) }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        @method('PUT')
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="ar[name]" value="{{ $instructor->translate('ar')->name }}" class="form-control"
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="en[name]" value="{{ $instructor->translate('en')->name }}" class="form-control"
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                <textarea class="default-ar {{ input_has_error('ar.bio',$errors) }}" name="ar[bio]">{!! $instructor->translate('ar')->bio !!}</textarea>
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    <textarea class="default-en {{ input_has_error('en.bio',$errors) }}" name="en[bio]">{!! $instructor->translate('en')->bio !!}</textarea>
                        ...
                        <div class="form-group col-12 col-md-12">
                            <div class="row">
                                ...
                                <div class="border mt-2">
                                    <img  width="150px" height="100px" src="{{ $instructor->image_path }}" alt="your image" />
                                </div>
                            </div>
                        </div>
