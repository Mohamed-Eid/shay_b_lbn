            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label d-flex justify-content-between w-100">
                        <h3 class="kt-portlet__head-title"> اضافة إيفينت جديد </h3>
                    </div>
                </div>
                <!--END:: TITLE-->

                <!--START:: ADD NEW EMPLOYEE FORM-->
                <form class="kt-form p-3 " method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="date" name="start_date" class="form-control {{ input_has_error('start_date',$errors) }}" placeholder="تاريخ بداية الإيفينت">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="time" name="start_time" class="form-control {{ input_has_error('start_time',$errors) }}" placeholder="وقت بداية الإيفينت">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="date" name="end_date" class="form-control {{ input_has_error('end_date',$errors) }}" placeholder="تاريخ نهاية الإيفينت">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="time" name="end_time" class="form-control {{ input_has_error('end_time',$errors) }}" placeholder="وقت نهاية الإيفينت">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="duration" class="form-control {{ input_has_error('duration',$errors) }}" placeholder="مدة الإيفينت">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="price" class="form-control {{ input_has_error('price',$errors) }}" placeholder="سعر إيفينت">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="number" min="0" max="99" name="discount" class="form-control {{ input_has_error('discount',$errors) }}" placeholder="نسبه الخصم">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="discount_message" class="form-control {{ input_has_error('discount_message',$errors) }}" placeholder="رسالة الخصم">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="video" class="form-control {{ input_has_error('video',$errors) }}" placeholder="فيديو تعريفي">
